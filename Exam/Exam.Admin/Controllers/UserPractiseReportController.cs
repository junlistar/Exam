...
{
    public class UserPractiseReportController : Controller
    {
        //方式1
        ...
        public UserPractiseReportController(IUserInfoService userService, IProblemRecordService problemRecordService)
        {
